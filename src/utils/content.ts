...
export const portfolioItems: PortfolioItem[] = [
  {
    ...
    time: { datetime: '2025-08', label: 'content.portfolio.0.timeLabel' },
  ...
  },
  {
    ...
    time: { datetime: '2022-08', label: 'content.portfolio.1.timeLabel' },
  ...
  {
    imgName: 'open-school',
    time: { datetime: '2022-05', label: 'content.portfolio.2.timeLabel' },
  ...
  },
  {
    ...
    time: { datetime: '2019-12', label: 'content.portfolio.3.timeLabel' },
