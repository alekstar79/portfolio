...
export const portfolioItems: PortfolioItem[] = [
  {
    imgName: 'linux-system',
    time: { datetime: '2026-05', label: 'content.portfolio.0.timeLabel' },
    titleKey: 'content.portfolio.0.title',
    href: 'https://alekstar79.github.io/linux-system',
    descriptionKey: 'content.portfolio.0.description',
    stack: ['TypeScript', 'Vite', 'React', 'React Hook Form', 'Zod', 'Tailwind', 'Lucide React', 'Radix Ui'],
    hasImageWrapperBorder: true,
  },
  {
    imgName: 'vue3-calendar',
    time: { datetime: '2025-08', label: 'content.portfolio.1.timeLabel' },
    titleKey: 'content.portfolio.1.title',
    href: 'https://alekstar79.github.io/vue3-calendar',
    descriptionKey: 'content.portfolio.1.description',
    stack: ['TypeScript', 'Vite', 'Vue', 'SCSS', 'Vitest'],
    hasImageWrapperBorder: true,
  },
  {
    imgName: 'round-layout',
    time: { datetime: '2022-08', label: 'content.portfolio.2.timeLabel' },
    titleKey: 'content.portfolio.2.title',
    href: 'https://alekstar79.github.io/round-layout',
    descriptionKey: 'content.portfolio.2.description',
    stack: ['HTML', 'SCSS', 'Vue', 'Gsap', 'Pixijs'],
    hasImageWrapperBorder: true,
  },
  {
    imgName: 'open-school',
    time: { datetime: '2022-05', label: 'content.portfolio.3.timeLabel' },
    titleKey: 'content.portfolio.3.title',
    href: 'https://2035school.ru',
    descriptionKey: 'content.portfolio.3.description',
    stack: ['JS', 'Vue', 'Vuex', 'Vue Router', 'MongoDB', 'Webpack', 'JWT', 'SCSS'],
  },
  {
    imgName: 'renovation-live',
    time: { datetime: '2019-12', label: 'content.portfolio.4.timeLabel' },
    href: 'https://alekstar79.github.io/renovation-live',
    titleKey: 'content.portfolio.4.title',
    descriptionKey: 'content.portfolio.4.description',
    stack: ['JS', 'WebPack'],
  },
]
